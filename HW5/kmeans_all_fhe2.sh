...
#SBATCH --job-name=KmeansAll


#SBATCH --output=/home/fhe2/CS599/HW5/kmeansAll.out

#SBATCH --error=/home/fhe2/CS599/HW5/kMeansAll.err

#SBATCH --time=1:00:00       ## for all ranks
